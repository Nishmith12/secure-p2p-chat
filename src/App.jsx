...
export default function App() {
  ...
  return (
    <div className="h-full bg-gray-900 font-sans antialiased text-gray-200 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl h-full max-h-[90vh] bg-gray-800 rounded-2xl shadow-2xl flex flex-col border border-gray-700">
        <header className="bg-gray-900 text-white p-4 rounded-t-2xl shadow-md flex justify-between items-center border-b border-gray-700">
          <div className="text-left">
            <h1 className="text-xl font-bold">Secure Peer-to-Peer Chat</h1>
            <p className="text-xs text-gray-400">Messages are sent directly and are never stored.</p>
          </div>
          {page === 'chat' && (
